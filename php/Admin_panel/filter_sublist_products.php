                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $query = "SELECT * FROM products WHERE subcatid = $subcategoryId";
                                            $result = $connect->query($query);


                                            $subcategoryQuery = "SELECT subcategoryname FROM subcategory WHERE subcatid = $subcategoryId";

                                            $subcategoryResult = $connect->query($subcategoryQuery);
